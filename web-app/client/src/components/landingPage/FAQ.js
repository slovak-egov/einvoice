...
const Section = ({children, eventKey, style, title}) => (
  <Card>
    <Accordion.Toggle
      as={Card.Header}
...
const VersionSection = ({children, ...props}) => (
  <Section style={{fontSize: '1.25rem', fontWeight: 500}} {...props}>
    <Accordion>
      {children}
    </Accordion>
  </Section>
...
const Version1 = ({eventKey}) => (
  <VersionSection title="Version 1 - (B/G)2(B/G) between Slovak invoicing Parties" eventKey={eventKey}>
    ...
    <Section title="I am a business and want to issue an invoice." eventKey="2">
      Three (maybe 4) ways:
      <ol>
        <li>
    ...
    <Section title="What validations does the system perform?" eventKey="4">
    ...
    <Section title="I would love to try the EINVOICE system before I do something serious." eventKey="7">
    ...
    <Section title="I got you! You have a bug in your EINVOICE system!" eventKey="11">
    ...
    <Section title="I would love to add the cool feature to the EINVOICE system." eventKey="13">
    ...
    <Section title="Is something different for government entities?" eventKey="18">
      Yes. Multiple things.
      <ol>
        <li>
...
const Version3 = ({eventKey}) => (
  <VersionSection title="Version 3 - (B/G)2G for foreign issuers" eventKey={eventKey}>
    <Section title="How does it work?" eventKey="0">
...
const Version4 = ({eventKey}) => (
  <VersionSection title="Version 4 - (B/G)2B for foreign issuers" eventKey={eventKey}>
    <Section title="How does it work?" eventKey="0">
      <strong>TBD</strong>
    </Section>
  </VersionSection>
...
const Version5 = ({eventKey}) => (
  <VersionSection title="Version 5 - (B/G)2C" eventKey={eventKey}>
    <Section title="How does it work?" eventKey="0">
      <strong>TBD</strong>
    </Section>
  </VersionSection>
